...
},
{
  ...
  mechanism: {
    en:
      "Acts on μ-opioid receptors and reduces pain signal transmission",

    bn:
      "μ-opioid receptor এ কাজ করে ব্যথার সংকেত কমায়"
  },
...
// ================= MORPHINE =================
{
  ...
  route: {
    en: "IV/IM/SC/Oral",
    bn: "শিরা/মাংসপেশি/ত্বকের নিচে/মুখে"
  },
  ...
  bestFor: {
    en: [
      "severe cancer pain",
      "terminal pain",
      "ICU level pain management"
    ],

    bn: [
      "তীব্র ক্যান্সারের ব্যথা",
      "শেষ পর্যায়ের ব্যথা",
      "ICU পর্যায়ের ব্যথা নিয়ন্ত্রণ"
    ]
  },
  ...
  mechanism: {
    ...
    bn:
      "সেন্ট্রাল নার্ভাস সিস্টেমে μ-opioid receptor সক্রিয় করে তীব্র ব্যথার সংকেত কমায়"
  },

  dosing: {
    adult: {
      en: "Dose varies depending on condition and route",
      bn: "রোগের অবস্থা ও ব্যবহারের পদ্ধতি অনুযায়ী ডোজ ভিন্ন হয়"
    }
  },
...
// ================= GABAPENTIN =================
{
  ...
  avoidIn: {
    en: [
      "severe kidney disease without dose adjustment",
      "gabapentin allergy",
      "severe sedation risk"
    ],

    bn: [
      "ডোজ সমন্বয় ছাড়া গুরুতর কিডনি রোগ",
      "গ্যাবাপেন্টিন অ্যালার্জি",
      "অতিরিক্ত ঘুম ভাবের ঝুঁকি"
    ]
  },
  ...
  doseNote: {
    en: "Should be tapered gradually instead of sudden stopping",

    bn: "হঠাৎ বন্ধ না করে ধীরে ধীরে কমানো উচিত"
  },
  ...
  usageType: {
    en: [
      "neuropathic pain control",
      "adjunct seizure control"
    ],

    bn: [
      "নার্ভের ব্যথা নিয়ন্ত্রণ",
      "খিঁচুনির সহায়ক চিকিৎসা"
    ]
  },
